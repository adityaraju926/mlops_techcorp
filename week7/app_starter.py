...
class Agent:
    ...
    def query(self, user_query: str, user_id: str = "anonymous", user_role: str = "engineer") -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    try:
        ...
        test_queries = [
            ("What is Brian Yang's salary?",                      "user1", "engineer"),
            ("What is Brian Yang's salary?",                      "user2", "hr"),
            ("What is Brian Yang's salary?",                      "user3", "executive"),
            ("Find information about Kim Martinez",               "user1", "engineer"),
            ("Find information about Kim Martinez",               "user2", "manager"),
            ("What is the travel policy?",                        "user1", "engineer"),
            ("What is the expense approval limit for a manager?", "user1", "engineer"),
            ("What is the code of conduct?",                      "user1", "engineer"),
        ]

        for i, (q, uid, role) in enumerate(test_queries, 1):
            print(f"Query {i}/{len(test_queries)} | user_id={uid} | role={role}")
            print(f"Q: {q}")
            result = agent.query(q, user_id=uid, user_role=role)
